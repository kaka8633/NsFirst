 ...
 */
function createForm1(request, response){
    ...
    if(request.getMethod() == 'GET'){
    	...
    	newForm.addField('custpage_textarea','textarea','请填写拒绝理由',null,'custpage_label');
    	newForm.setScript('customscript_emp_approval_click_cs');
    	newForm.setScript('customscript_emp_approval_hidden_cs');
    	...
    	newForm.addButton('custpage_button', '提交', 'refuse_A()');
